            ...
            <Col md={4}>
              <Card>
                <ListGroup variant="flush">
                  ...
                  <ListGroup.Item>Vendido Por: {product.seller}</ListGroup.Item>
                </ListGroup>
              </Card>
            </Col>
            <Col md={3}>
            ...
            <Col md={12}>
              <ListGroup variant="flush">
                {product.reviews.length === 0 ? (
                  <h3 style={{ textAlign: "center" }}>Sin Reseñas</h3>
                ) : (
                  <h3 style={{ textAlign: "center" }}>Reseñas</h3>
                )}
                  ...
                  {user ? (
                    <Form onSubmit={reviewHandler}>
                      <Form.Group controlId="rating">
                        <Form.Label>¿Que te parece el producto?</Form.Label>
                        <Form.Control
                          as="select"
                          value={rating}
